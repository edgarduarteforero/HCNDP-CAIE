...
for K in range (min_K , max_K+1):
    for nodos in range (min_I , max_I+1):    
        ...
        #for operador in operadores:
            #for metaheuristica in range (3,4+1): #Número de metaheurísticas
        for objetivo in range (3,3+1): #Objetivo de la función objetivo
            ...
            ruta_destino = os.path.join(ruta_actual, "tests", "20240626 Experimento Optima")
            ...
            prefijo = str(I)+str(J)+str(K)+"_Oper_"+str(objetivo)+"_"
            ...
            _patron_tiempo_solucion_gurobi = r"Tiempo solución Gurobi: \s*(.*)"  # Captura todo texto después "Tiempo solución Gurobi: "
            ...
            _valores_tiempo_solucion_gurobi = re.findall(_patron_tiempo_solucion_gurobi, stdout)  # Devuelve el tiempo de solución por optimización
            ...
            lista_resultados=[_valores_vecindario_final[0],
                                     ...
                                     str(objetivo),#
                                     #str(operador),#
                                     _valores_tiempo_solucion_gurobi[0],
                                     ]
            ...
            lista_completa[str(str(I)+str(J)+str(K)+"_"+str(objetivo))] = lista_resultados
