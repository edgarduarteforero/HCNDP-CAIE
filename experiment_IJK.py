...
for K in range (min_K , max_K+1):
    for nodos in range (min_I , max_I+1):    
        ...
        #for metaheuristica in range (3,6+1): #Número de metaheurísticas
                #for objetivo in range (1,3+1): #Objetivo de la función objetivo
                    ...
                    ruta_destino = os.path.join(ruta_actual, "tests", "20240602 Experimento LS alpha")
