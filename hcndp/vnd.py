...
def vnd_search(current_solution,network_original):
    ...
    # operadores VNS
    operadores = {
    8:'incremento1_decremento1_exhaust', 
    7:'incremento1_exhaust',
    6:'incremento1_all',
    5:'incremento2_decremento1_exhaust', 
    4:'incremento2_decremento2_exhaust', 
    3:'incremento3_decremento3_exhaust', 
    2:'chain_reaction_exhaust_plus_minus',
    1:'chain_reaction_exhaust_minus_plus'
    }
    # operadores = {
    # 1:'incremento2_decremento2_exhaust',
    # 2:'incremento2_decremento1_exhaust',
    # 3:'incremento3_decremento3_exhaust',
    # 4:'chain_reaction_exhaust_plus_minus',
    # 5:'chain_reaction_exhaust_minus_plus',
    # 6:'incremento1_all',
    # 7:'incremento1_decremento1_exhaust',
    # 8:'incremento1_exhaust'
    # }
