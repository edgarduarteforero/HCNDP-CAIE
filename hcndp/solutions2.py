...
def menu_solutions(network_original, problems_dict):
    ...
    while True:
        ...
        if opcion == "1":
            ...
            create_problem_object(network_original, problems_dict, name_problem="temporal")
            ...
            if current_solution.optimizar==True and current_solution.tecnica=="Solucion_Inicial":
                #from hcndp import initial_solution
                current_solution.initial_solution(network_original)
                #initial_solution.initial_solution(current_solution,network_original)
            ...
            if current_solution.optimizar==True and current_solution.tecnica=="Local_Search":
                ...
                #current_solution.initial_solution(network_original)
                local_search.local_search(current_solution,network_original)
...
# %% Funciones complementarias
    ...
    def replace_name_solution(self, new_network, problems_dict,objective_and_description):
        # Actualiza el nombre del objeto según la solucióny método escogido
        if self.network_copy.optimizar==True and hasattr(self, 'tecnica'): #self.tecnica != "Exacta":
    ...
    def menu_mono_optimization(self, new_network, problems_dict):
        while True:
            ...
            print("2. Solución inicial")
            print("3. Solución por búsqueda local")
            print("4. Solución por Iterated Local Search")
            print("5. Solución por Variable Neighborhood Search")
            ...
            if opcion1 == "1":
                ...
                #Actualizo nombres de objetos
                self.replace_name_solution(new_network, problems_dict, objective_and_description)
                ...
                self.optimizar=True
                self.tecnica="Iterated_Local_Search"
                # Presento menú de funciones objetivo disponibles
                objective_and_description = new_network.get_objective_function()
    ...
    def set_solution_excel(self):
        ...
        # Obtengo los datos si la solución fue por Solución_Inicial
        if self.tecnica=='Solucion_Inicial':
...
# %% Tipo de solución
    ...
    def initial_solution(self,network_original):
        ...
        self.state="Solucionado_Solución_Inicial"
