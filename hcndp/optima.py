...
# #opt.options['FeasibilityTol']=0.001 # Primal feasibility tolerance
...
# #opt.options['OptimalityTol']=0.001 # Dual feasibility tolerance ###### Este generó un cambio importante
# #opt.options['MIPGap']=0.01
# #opt.options['MIPFocus']= 3 #
# #opt.options['SimplexPricing']=0
# #opt.options['PreQLinearize']=2
# #opt.options['GomoryPasses']= 1
# #opt.options['PrePasses']= 5
# #opt.options['Presolve']= 1
# #opt.options['ScaleFlag']=2 #,1,2,3
# #opt.options['ZeroObjNodes']=1000
# #opt.options['TimeLimit']=120

# #%% <codecell> Resolver por Gurobi
...
#     global out
#     out=0
#     results=opt.solve(instance, tee=True, warmstart=False, logfile='logfile_name.log')
#     # Accessing solver status: http://www.pyomo.org/blog/2015/1/8/accessing-solver
#     if (results.solver.status == pyo.SolverStatus.ok) and (results.solver.termination_condition == pyo.TerminationCondition.optimal):
#         out="optimal and feasible"
#         #results.write()
...
# #%% <codecell> Resolver por Mindtpy
# def resolver_mindtpy(instance):
...
# #%% <codecell> Resolver por ipopt

# def resolver_ipopt(instance):
#     opt=pyo.SolverFactory('ipopt')
...
# #%% <codecell> Resolver por glpk
# def resolver_glpk(instance):
